...
export var useLineChart = function (props) {
    ...
    var showDataPointsForMissingValues = props.showDataPointsForMissingValues, _308 = props.interpolateMissingValues, interpolateMissingValues = _308 === void 0 ? true : _308, _309 = props.extrapolateMissingValues, extrapolateMissingValues = _309 === void 0 ? true : _309, yAxisOffset = props.yAxisOffset, parentWidth = props.parentWidth, negativeStepValue = props.negativeStepValue;
    ...
    var _310 = __read(useState(0), 2), scrollX = _310[0], setScrollX = _310[1];
    var _311 = __read(useState(''), 2), arrow1Points = _311[0], setArrow1Points = _311[1];
    var _312 = __read(useState(''), 2), arrow2Points = _312[0], setArrow2Points = _312[1];
    var _313 = __read(useState(''), 2), arrow3Points = _313[0], setArrow3Points = _313[1];
    var _314 = __read(useState(''), 2), arrow4Points = _314[0], setArrow4Points = _314[1];
    var _315 = __read(useState(''), 2), arrow5Points = _315[0], setArrow5Points = _315[1];
    var _316 = __read(useState(''), 2), secondaryArrowPoints = _316[0], setSecondaryArrowPoints = _316[1];
    var _317 = __read(useState(-1), 2), pointerIndex = _317[0], setPointerIndex = _317[1];
    var _318 = __read(useState(0), 2), pointerX = _318[0], setPointerX = _318[1];
    var _319 = __read(useState(0), 2), pointerY = _319[0], setPointerY = _319[1];
    var _320 = __read(useState(), 2), pointerItem = _320[0], setPointerItem = _320[1];
    var _321 = __read(useState(0), 2), pointerY2 = _321[0], setPointerY2 = _321[1];
    var _322 = __read(useState(), 2), pointerItem2 = _322[0], setPointerItem2 = _322[1];
    var _323 = __read(useState(0), 2), pointerY3 = _323[0], setPointerY3 = _323[1];
    var _324 = __read(useState(), 2), pointerItem3 = _324[0], setPointerItem3 = _324[1];
    var _325 = __read(useState(0), 2), pointerY4 = _325[0], setPointerY4 = _325[1];
    var _326 = __read(useState(), 2), pointerItem4 = _326[0], setPointerItem4 = _326[1];
    var _327 = __read(useState(0), 2), pointerY5 = _327[0], setPointerY5 = _327[1];
    var _328 = __read(useState([]), 2), pointerYsForDataSet = _328[0], setPointerYsForDataSet = _328[1];
    var _329 = __read(useState(), 2), pointerItem5 = _329[0], setPointerItem5 = _329[1];
    var _330 = __read(useState(0), 2), secondaryPointerY = _330[0], setSecondaryPointerY = _330[1];
    var _331 = __read(useState(), 2), secondaryPointerItem = _331[0], setSecondaryPointerItem = _331[1];
    var _332 = __read(useState([]), 2), pointerItemsForSet = _332[0], setPointerItemsForSet = _332[1];
    var _333 = __read(useState([]), 2), secondaryPointerItemsForSet = _333[0], setSecondaryPointerItemsForSet = _333[1];
    var _334 = __read(useState(0), 2), responderStartTime = _334[0], setResponderStartTime = _334[1];
    var _335 = __read(useState(false), 2), responderActive = _335[0], setResponderActive = _335[1];
    var _336 = __read(useState(''), 2), points = _336[0], setPoints = _336[1];
    var _337 = __read(useState(''), 2), points2 = _337[0], setPoints2 = _337[1];
    var _338 = __read(useState(''), 2), points3 = _338[0], setPoints3 = _338[1];
    var _339 = __read(useState(''), 2), points4 = _339[0], setPoints4 = _339[1];
    var _340 = __read(useState(''), 2), points5 = _340[0], setPoints5 = _340[1];
    var _341 = __read(useState(''), 2), secondaryPoints = _341[0], setSecondaryPoints = _341[1];
    var _342 = __read(useState(''), 2), fillPoints = _342[0], setFillPoints = _342[1];
    var _343 = __read(useState(''), 2), fillPoints2 = _343[0], setFillPoints2 = _343[1];
    var _344 = __read(useState(''), 2), fillPoints3 = _344[0], setFillPoints3 = _344[1];
    var _345 = __read(useState(''), 2), fillPoints4 = _345[0], setFillPoints4 = _345[1];
    var _346 = __read(useState(''), 2), fillPoints5 = _346[0], setFillPoints5 = _346[1];
    var _347 = __read(useState(''), 2), secondaryFillPoints = _347[0], setSecondaryFillPoints = _347[1];
    var _348 = __read(useState([]), 2), pointsFromSet = _348[0], setPointsFromSet = _348[1];
    var _349 = __read(useState([]), 2), fillPointsFromSet = _349[0], setFillPointsFromSet = _349[1];
    var _350 = __read(useState([]), 2), arrowPointsFromSet = _350[0], setArrowPointsFromSet = _350[1];
    var _351 = __read(useState((_j = props.focusedDataPointIndex) !== null && _j !== void 0 ? _j : -1), 2), selectedIndex = _351[0], setSelectedIndex = _351[1];
    useEffect(function () {
        var _a;
    ...
    var secondaryRoundToDigits = (_111 = (_110 = props.secondaryYAxis) === null || _110 === void 0 ? void 0 : _110.roundToDigits) !== null && _111 !== void 0 ? _111 : (showSecondaryFractionalValues
        ...
        : 0);
    var _353 = computeMaxAndMinItems(mergedSecondaryDataArrays, secondaryRoundToDigits, showSecondaryFractionalValues), secondaryMaxItem = _353.maxItem, secondaryMinItem = _353.minItem;
    ...
    var _354 = getAllArrowProperties(props, defaultArrowConfig), arrowLength1 = _354.arrowLength1, arrowWidth1 = _354.arrowWidth1, arrowStrokeWidth1 = _354.arrowStrokeWidth1, arrowStrokeColor1 = _354.arrowStrokeColor1, arrowFillColor1 = _354.arrowFillColor1, showArrowBase1 = _354.showArrowBase1, arrowLength2 = _354.arrowLength2, arrowWidth2 = _354.arrowWidth2, arrowStrokeWidth2 = _354.arrowStrokeWidth2, arrowStrokeColor2 = _354.arrowStrokeColor2, arrowFillColor2 = _354.arrowFillColor2, showArrowBase2 = _354.showArrowBase2, arrowLength3 = _354.arrowLength3, arrowWidth3 = _354.arrowWidth3, arrowStrokeWidth3 = _354.arrowStrokeWidth3, arrowStrokeColor3 = _354.arrowStrokeColor3, arrowFillColor3 = _354.arrowFillColor3, showArrowBase3 = _354.showArrowBase3, arrowLength4 = _354.arrowLength4, arrowWidth4 = _354.arrowWidth4, arrowStrokeWidth4 = _354.arrowStrokeWidth4, arrowStrokeColor4 = _354.arrowStrokeColor4, arrowFillColor4 = _354.arrowFillColor4, showArrowBase4 = _354.showArrowBase4, arrowLength5 = _354.arrowLength5, arrowWidth5 = _354.arrowWidth5, arrowStrokeWidth5 = _354.arrowStrokeWidth5, arrowStrokeColor5 = _354.arrowStrokeColor5, arrowFillColor5 = _354.arrowFillColor5, showArrowBase5 = _354.showArrowBase5, arrowLengthsFromSet = _354.arrowLengthsFromSet, arrowWidthsFromSet = _354.arrowWidthsFromSet, arrowStrokeWidthsFromSet = _354.arrowStrokeWidthsFromSet, arrowStrokeColorsFromSet = _354.arrowStrokeColorsFromSet, arrowFillColorsFromSet = _354.arrowFillColorsFromSet, showArrowBasesFromSet = _354.showArrowBasesFromSet;
    ...
    var activatePointersDelay = (_275 = pointerConfig === null || pointerConfig === void 0 ? void 0 : pointerConfig.activatePointersDelay) !== null && _275 !== void 0 ? _275 : defaultPointerConfig.activatePointersDelay;
    var initialPointerIndex = (_276 = pointerConfig === null || pointerConfig === void 0 ? void 0 : pointerConfig.initialPointerIndex) !== null && _276 !== void 0 ? _276 : defaultPointerConfig.initialPointerIndex;
    var initialPointerAppearDelay = (_277 = pointerConfig === null || pointerConfig === void 0 ? void 0 : pointerConfig.initialPointerAppearDelay) !== null && _277 !== void 0 ? _277 : (isAnimated
        ? animationDuration
        : defaultPointerConfig.initialPointerAppearDelay);
    var persistPointer = (_278 = pointerConfig === null || pointerConfig === void 0 ? void 0 : pointerConfig.persistPointer) !== null && _278 !== void 0 ? _278 : defaultPointerConfig.persistPointer;
    var hidePointers = (_279 = pointerConfig === null || pointerConfig === void 0 ? void 0 : pointerConfig.hidePointers) !== null && _279 !== void 0 ? _279 : defaultPointerConfig.hidePointers;
    var hidePointer1 = (_280 = pointerConfig === null || pointerConfig === void 0 ? void 0 : pointerConfig.hidePointer1) !== null && _280 !== void 0 ? _280 : defaultPointerConfig.hidePointer1;
    var hidePointer2 = (_281 = pointerConfig === null || pointerConfig === void 0 ? void 0 : pointerConfig.hidePointer2) !== null && _281 !== void 0 ? _281 : defaultPointerConfig.hidePointer2;
    var hidePointer3 = (_282 = pointerConfig === null || pointerConfig === void 0 ? void 0 : pointerConfig.hidePointer3) !== null && _282 !== void 0 ? _282 : defaultPointerConfig.hidePointer3;
    var hidePointer4 = (_283 = pointerConfig === null || pointerConfig === void 0 ? void 0 : pointerConfig.hidePointer4) !== null && _283 !== void 0 ? _283 : defaultPointerConfig.hidePointer4;
    var hidePointer5 = (_284 = pointerConfig === null || pointerConfig === void 0 ? void 0 : pointerConfig.hidePointer5) !== null && _284 !== void 0 ? _284 : defaultPointerConfig.hidePointer5;
    var hideSecondaryPointer = (_285 = pointerConfig === null || pointerConfig === void 0 ? void 0 : pointerConfig.hideSecondaryPointer) !== null && _285 !== void 0 ? _285 : defaultPointerConfig.hideSecondaryPointer;
    var resetPointerOnDataChange = (_286 = pointerConfig === null || pointerConfig === void 0 ? void 0 : pointerConfig.resetPointerOnDataChange) !== null && _286 !== void 0 ? _286 : defaultPointerConfig.resetPointerOnDataChange;
    var pointerEvents = pointerConfig === null || pointerConfig === void 0 ? void 0 : pointerConfig.pointerEvents;
    var disableScroll = (_287 = props.disableScroll) !== null && _287 !== void 0 ? _287 : (pointerConfig
        ? activatePointersOnLongPress
            ? !!responderActive
            : true
        : false);
    var showScrollIndicator = (_288 = props.showScrollIndicator) !== null && _288 !== void 0 ? _288 : LineDefaults.showScrollIndicator;
    var focusEnabled = (_289 = props.focusEnabled) !== null && _289 !== void 0 ? _289 : LineDefaults.focusEnabled;
    var showDataPointOnFocus = (_290 = props.showDataPointOnFocus) !== null && _290 !== void 0 ? _290 : LineDefaults.showDataPointOnFocus;
    var showStripOnFocus = (_291 = props.showStripOnFocus) !== null && _291 !== void 0 ? _291 : LineDefaults.showStripOnFocus;
    var showTextOnFocus = (_292 = props.showTextOnFocus) !== null && _292 !== void 0 ? _292 : LineDefaults.showTextOnFocus;
    var showDataPointLabelOnFocus = (_293 = props.showDataPointLabelOnFocus) !== null && _293 !== void 0 ? _293 : LineDefaults.showDataPointLabelOnFocus;
    var stripHeight = props.stripHeight;
    var stripWidth = (_294 = props.stripWidth) !== null && _294 !== void 0 ? _294 : LineDefaults.stripWidth;
    var stripColor = (_295 = props.stripColor) !== null && _295 !== void 0 ? _295 : color1;
    var stripOpacity = (_296 = props.stripOpacity) !== null && _296 !== void 0 ? _296 : (startOpacity1 + endOpacity1) / 2;
    var stripStrokeDashArray = props.stripStrokeDashArray;
    var unFocusOnPressOut = (_297 = props.unFocusOnPressOut) !== null && _297 !== void 0 ? _297 : LineDefaults.unFocusOnPressOut;
    var delayBeforeUnFocus = (_298 = props.delayBeforeUnFocus) !== null && _298 !== void 0 ? _298 : LineDefaults.delayBeforeUnFocus;
    var lineGradient = (_299 = props.lineGradient) !== null && _299 !== void 0 ? _299 : LineDefaults.lineGradient;
    var lineGradientDirection = (_300 = props.lineGradientDirection) !== null && _300 !== void 0 ? _300 : 'vertical';
    var lineGradientStartColor = (_301 = props.lineGradientStartColor) !== null && _301 !== void 0 ? _301 : LineDefaults.lineGradientStartColor;
    var lineGradientEndColor = (_302 = props.lineGradientEndColor) !== null && _302 !== void 0 ? _302 : LineDefaults.lineGradientEndColor;
    ...
    var dataPointsRadius = (_304 = (_303 = props.dataPointsRadius1) !== null && _303 !== void 0 ? _303 : props.dataPointsRadius) !== null && _304 !== void 0 ? _304 : LineDefaults.dataPointsRadius;
    var dataPointsWidth = (_306 = (_305 = props.dataPointsWidth1) !== null && _305 !== void 0 ? _305 : props.dataPointsWidth) !== null && _306 !== void 0 ? _306 : LineDefaults.dataPointsWidth;
    ...
    var barAndLineChartsWrapperProps = {
        ...
        endReachedOffset: (_307 = props.endReachedOffset) !== null && _307 !== void 0 ? _307 : LineDefaults.endReachedOffset,
